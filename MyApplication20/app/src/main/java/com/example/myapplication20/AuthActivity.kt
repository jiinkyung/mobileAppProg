...
import com.example.myapplication20.MyApplication.Companion.auth
        ...
        binding.btnKakaoLogin.setOnClickListener {
            ...
            UserApiClient.instance.accessTokenInfo { tokenInfo, error ->
                if (error != null) {
                    ...
                    Log.d("mobileApp", "${tokenInfo}")
                    Log.d("mobileApp","${error.message.toString()}")
                    ...
                    UserApiClient.instance.me { user, error ->
                        if (error != null) {
                            ...
                            if(user.kakaoAccount?.email != null) {
                                ...
                                Log.e("mobileApp", "이메일 획득 실패", error)
                            }
                        }
                    }
                }
